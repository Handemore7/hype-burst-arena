    ...
    extend: {
      colors: {
        ...
        team: {
          ...
          "cyan-glow": "hsl(var(--team-cyan-glow))",
          purple: "hsl(var(--team-purple))",
          "purple-glow": "hsl(var(--team-purple-glow))",
          amber: "hsl(var(--team-amber))",
          "amber-glow": "hsl(var(--team-amber-glow))",
        },
        winner: {
          gold: "hsl(var(--winner-gold))",
          "gold-glow": "hsl(var(--winner-gold-glow))",
        },
      },
      backgroundImage: {
